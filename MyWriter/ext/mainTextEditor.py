...
class MainTextEditor(QtGui.QMainWindow):
    ...
    def dragMoveEvent(self, event):
        if event.mimeData().hasUrls:
            ...
            s
            self.text.drag.setDragCursor( cursor, QtCore.Qt.CopyAction + QtCore.Qt.MoveAction )
            print(pos)
        else:
            event.ignore()
